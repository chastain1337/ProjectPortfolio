  ...
  const projects = [
    ...
    },
    {
      ...
      column1Data: {
        ...
        downloadExeUrl: process.env.PUBLIC_URL + "/eBay_Product_Details_Getter.zip",
      },
      projectDetails: [
        new ProjectDetailInfo("Inspiration","The disconinuation of TurboLister, its limited functionality beyond a few-thousand listings, and a difficult-to-utilize SOAP API."),
        new ProjectDetailInfo("Challenges","Learning PyQt5, ET, and threading from scratch; the API's page and date limitations."),
        new ProjectDetailInfo("Solutions","Thoroughly reading documentation, testing code in small bites, and planning before writing.")
      ]
    },
    {
      name: "Decision Maker",
      ...
      column1Data: {
        imageUrl: "",
        sourceUrl: "",
        liveDemoUrl: "not empty",
      },
      projectDetails: [
        new ProjectDetailInfo("Purpose","Exposing myself to Bootstrap and React through a small, single-page project."),
        new ProjectDetailInfo("Challenges","Utilizing state and mobile-first design."),
